...
const Weather = ({description, city, country, error, temperature }) => {
    ...
    //function that matches weather keywords with weather description
    //weather description converts into an array of strings
    //for loop iterates through each word in array
    //image is returned if keywords are included
